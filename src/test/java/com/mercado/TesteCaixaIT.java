...
public class TesteCaixaIT {
	...
	public void SetUp() {
		...
		jsonCaixaIncorretoSemNome = ResourceUtils.getContentFromResource("/json/incorreto/caixa/caixa-incorreto-sem-nome.json");
		jsonCaixaIncorretoSemSaldo = ResourceUtils.getContentFromResource("/json/incorreto/caixa/caixa-incorreto-sem-saldo.json");
		jsonCaixaIncorretoSaldo = ResourceUtils.getContentFromResource("/json/incorreto/caixa/caixa-incorreto-saldo.json");
		jsonCaixaIncorretoSemLoja = ResourceUtils.getContentFromResource("/json/incorreto/caixa/caixa-incorreto-sem-loja.json");
		jsonCaixaIncorretoLojaInexistente = ResourceUtils.getContentFromResource("/json/incorreto/caixa/caixa-incorreto-loja-inexistente.json");
	}
	...
	public void deveRetornarStatus404_QuandoConsultarCaixaInexistente() {
		given()
			.accept(ContentType.JSON)
			.pathParam("id", idCaixaInexistente)
		.when()
			.get("/{id}")
		.then()
	...
	public void deveRetornarStatus400_QuandoCadastrarCaixaSemNome() {
		given()
			.body(jsonCaixaIncorretoSemNome)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarCaixaSemSaldo() {
		given()
			.body(jsonCaixaIncorretoSemSaldo)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarCaixaSemLoja() {
		given()
			.body(jsonCaixaIncorretoSemLoja)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarCaixaLojaInexistente() {
		given()
			.body(jsonCaixaIncorretoLojaInexistente)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
