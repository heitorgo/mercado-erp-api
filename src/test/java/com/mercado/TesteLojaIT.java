...
public class TesteLojaIT {
	...
	public void SetUp() {
		...
		jsonLojaIncorretaSemNome = ResourceUtils.getContentFromResource("/json/incorreto/loja/loja-incorreta-sem-nome.json");
		jsonLojaIncorretaSemEmpresa = ResourceUtils.getContentFromResource("/json/incorreto/loja/loja-incorreta-sem-empresa.json");
		jsonLojaIncorretaEmpresaInexistente = ResourceUtils.getContentFromResource("/json/incorreto/loja/loja-incorreta-empresa-inexistente.json");
	}
	...
	public void deveRetornarStatus404_QuandoConsultarLojaInexistente() {
		given()
			.accept(ContentType.JSON)
			.pathParam("id", idLojaInexistente)
		.when()
			.get("/{id}")
		.then()
	...
	public void deveRetornarStatus400_QuandoCadastrarLojaSemEmpresa() {
		given()
			.body(jsonLojaIncorretaSemEmpresa)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarLojaEmpresaInexistente() {
		given()
			.body(jsonLojaIncorretaEmpresaInexistente)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
