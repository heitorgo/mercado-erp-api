...
public class TesteFuncionarioIT {
	...
	public void SetUp() {
		...
		jsonFuncionarioIncorretoSemNome = ResourceUtils.getContentFromResource("/json/incorreto/funcionario/funcionario-incorreto-sem-nome.json");
		jsonFuncionarioIncorretoSemCargo = ResourceUtils.getContentFromResource("/json/incorreto/funcionario/funcionario-incorreto-sem-cargo.json");
		jsonFuncionarioIncorretoCargoInexistente = ResourceUtils.getContentFromResource("/json/incorreto/funcionario/funcionario-incorreto-cargo-inexistente.json");
	}
	...
	public void deveRetornarStatus200_QuandoConsultarFuncionarioExistente() {
		given()
			.accept(ContentType.JSON)
			.pathParam("id", funcionario1.getId())
		.when()
			.get("/{id}")
		.then()
			.statusCode(HttpStatus.OK.value());
	...
	public void deveRetornarStatus404_QuandoConsultarFuncionarioInexistente() {
		given()
			.accept(ContentType.JSON)
			.pathParam("id", idFuncionarioInexistente)
		.when()
			.get("/{id}")
		.then()
	...
	public void deveRetornarStatus400_QuandoCadastrarFuncionarioSemNome() {
		given()
			.body(jsonFuncionarioIncorretoSemNome)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarFuncionarioSemCargo() {
		given()
			.body(jsonFuncionarioIncorretoSemCargo)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarFuncionarioCargoInexistente() {
		given()
			.body(jsonFuncionarioIncorretoCargoInexistente)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
