...
public class TesteVendaIT {
	...
	public void SetUp() {
		...
		jsonVendaIncorretoSemValor = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-sem-valor.json");
		jsonVendaIncorretoValor = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-valor.json");
		jsonVendaIncorretoSemDescricao = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-sem-descricao.json");
		jsonVendaIncorretoSemCaixa = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-sem-caixa.json");
		jsonVendaIncorretoCaixaInexistente = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-caixa-inexistente.json");
		jsonVendaIncorretoSemFuncionario = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-sem-funcionario.json");
		jsonVendaIncorretoFuncionarioInexistente = ResourceUtils.getContentFromResource("/json/incorreto/venda/venda-incorreto-funcionario-inexistente.json");
	}
	...
	public void deveRetornarStatus404_QuandoConsultarVendaInexistente() {
		given()
			.accept(ContentType.JSON)
			.pathParam("id", idVendaInexistente)
		.when()
			.get("/{id}")
		.then()
	...
	public void deveRetornarStatus400_QuandoCadastrarVendaSemValor() {
		given()
			.body(jsonVendaIncorretoSemValor)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarVendaSemDescricao() {
		given()
			.body(jsonVendaIncorretoSemDescricao)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarVendaSemCaixa() {
		given()
			.body(jsonVendaIncorretoSemCaixa)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarVendaFuncionarioInexistente() {
		given()
			.body(jsonVendaIncorretoFuncionarioInexistente)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
	...
	public void deveRetornarStatus400_QuandoCadastrarVendaCaixaInexistente() {
		given()
			.body(jsonVendaIncorretoCaixaInexistente)
			.accept(ContentType.JSON)
			.contentType(ContentType.JSON)
		.when()
			.post()
