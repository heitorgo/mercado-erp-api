package com.mercado.api.exceptionhandler;
...
import com.mercado.core.validation.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if(body == null) {
			body = Problem.builder()
					...
					.status(status.value())
					.userMesage(MSG_ERRO_GENERICA_USUARIO_FINAL)
					.build();
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, 
		...
		String detail = String.format("O parametro de URL %s recebeu valor %s, que é do tipo inválido." 
